...
<?php $component->withAttributes([]); ?>
    <div class="mb-4 text-center">
        <h2 class="text-lg font-bold">
            Login sebagai <?php echo e(request('as', 'user') === 'admin' ? 'Admin' : 'User'); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <!-- Kirim informasi login sebagai apa -->
        <input type="hidden" name="as" value="<?php echo e(request('as', 'user')); ?>">
...
<?php endif; ?>
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(route('register')); ?>" class="text-sm text-blue-600 hover:underline">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\projek_pemweb\ulm_realtime\resources\views/auth/login.blade.php ENDPATH**/ ?>